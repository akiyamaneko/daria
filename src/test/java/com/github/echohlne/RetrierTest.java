package com.github.echohlne;


import com.github.echohlne.strategy.Retrier;
import com.github.echohlne.strategy.StrategyGenerator;
...
public class RetrierTest {
    ...
    private Retrier.Builder createDefaultBuilder() {
        return new Retrier.Builder().withStopStrategy(StrategyGenerator.stopAfterMaxAttempts(MAX_ATTEMPTS));
    }
    ...
    public void shouldRetryWhenUsingCustomRetryStrategy() throws Exception {
        ...
        victim = new Retrier.Builder().withResultRetryStrategy(i -> i.equals(retryResult))
            .withStopStrategy(StrategyGenerator.stopAfterMaxAttempts(MAX_ATTEMPTS)).build();
    ...
    public void shouldInvokeWaitStrategyForEveryRetry() throws Exception {
        ...
        victim = createDefaultBuilder().withWaitStrategy(waitStrategy).withFailedRetryStrategy(StrategyGenerator.retryOnException(Exception.class))
            .build();
